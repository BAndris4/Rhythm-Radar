...
function Artists() {
    ...
    return (
        <div className="tracks-page bg-[#E8FCCF] min-h-dvh">
            <Navbar />
            <div className="tracks-container flex flex-col text-[#134611] items-center">
                ...
                <div className="tracks-body text-sm flex flex-col sm:w-4/5 w-[90%] items-center my-10 shadow-2xl shadow-[#134611]">
                    ...
                    <div className="track-body w-full pt-2 bg-[#96E072]">
                        {tracks.map((track, id) => (
                            <div key={id} className="track-item py-1 cursor-pointer flex gap-1 px-2 bg-[#96E072] rounded-xl duration-200 hover:shadow-xl hover:scale-105 hover:bg-[#3DA35D] w-full" onClick={() => playPreview(previews[id], id)} onMouseEnter={() => setHoveredIndex(id)} 
