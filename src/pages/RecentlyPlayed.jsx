                ...
                <div className="recently-played-table my-10 w-4/5 shadow-2xl shadow-[#134611] text-[#134611]">
                    ...
                    <div className="table-body pt-2 bg-[#96E072]">
                        {recentTracks.map((track, index) => (
                            <div className="table-body-row cursor-pointer flex bg-[#96E072] rounded-xl duration-200 hover:shadow-xl hover:scale-105 hover:bg-[#3DA35D]" onClick={() => playPreview(previews[index], index)} >
                                <div className="w-[5%] flex items-center justify-center min-w-14 py-1">
                                    <img src={albumImages[index]} className={`w-12 rounded-xl shadow-sm shadow-[#134611] ${blurredImage === index ? "blur-[1px]" : ""} duration-200`} alt=""/>
                                    <img src="../src/assets/play-button.svg" alt="" className={`opacity-0 z-10 drop-shadow-[0_0px_3px_rgba(0,0,0,1)] hover:${blurredImage === index ? "opacity-0" : "opacity-100"} w-5 absolute duration-200`} />
                                    <img src="../src/assets/pause-button.svg" alt="" className={`opacity-0 z-0 drop-shadow-[0_0px_3px_rgba(0,0,0,1)] ${blurredImage === index ? "opacity-100" : ""} w-5 absolute duration-200`} />
                                </div>
