...
function Login(){
    ...
    <div className="login-body bg-[var(--color1)] flex justify-center items-center h-svh">
        {!token ?  
            <div className='login-container bg-[var(--color2)] flex flex-col items-center justify-between py-5 gap-10 p-4 sm:w-[80%] w-72 rounded-3xl shadow-2xl shadow-[--color2]'>
