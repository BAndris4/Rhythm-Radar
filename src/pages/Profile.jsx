...
function Profile(){
    ...
    return(
        <div className="profile-page bg-[#E8FCCF] min-h-svh">
            <Navbar></Navbar>
            <div className="xl:h-[75svh] xl:flex xl:justify-center xl:items-center">
                <div className="flex-1 profile-container flex xl:flex-row flex-col justify-center xl:gap-12 gap-6">
                    ...
                    <div className="profile-left-data-card-xl text-center flex flex-col justify-around mt-16 bg-[#96E072] hover:bg-[#3DA35D] absolute xl:relative translate-x-[-500px] xl:translate-x-0 w-1/4 p-5 shadow-2xl shadow-[#96E072] hover:shadow-[#3DA35D] rounded-2xl hover:scale-110 transition-all duration-300">
                        ...
                        <h2 className="text-xl font-semibold text-[#134611] hover:text-[#E8FCCF] transition-all cursor-pointer duration-200">Product: {product} </h2>
                        <h2 className="text-xl font-semibold text-[#134611] hover:text-[#E8FCCF] transition-all cursor-pointer duration-200">Public playlists: {publicPlaylists} </h2>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row mx-[5%] xl:absolute gap-5 xl:translate-x-[-6000px] my-0">
                        ...
                        <div className="profile-right-data-card flex justify-evenly items-center bg-[#96E072] hover:bg-[#3DA35D] xl:w-1/5 w-full md:w-1/2 py-10 shadow-2xl shadow-[#96E072] hover:shadow-[#3DA35D] rounded-2xl hover:scale-105 transition-all duration-300">
                            {publicPlaylists <= 3 ? (
                    ...
                    <div className="profile-welcome-card-xl flex items-center translate-x-[-1500px] absolute xl:relative xl:translate-x-0 justify-center flex-col gap-3 mt-16 bg-[#96E072] hover:bg-[#3DA35D] xl:w-2/5 w-full py-10 shadow-2xl shadow-[#96E072] hover:shadow-[#3DA35D] rounded-2xl hover:scale-110 transition-all duration-300">
                        <a href={link}><img className="profile-pic h-56 w-56 rounded-full cover shadow-md shadow-[#134611] hover:scale-110 duration-200" src={imgURL}></img></a>
                        <h2 className="text-3xl font-semibold text-[#134611] hover:text-[#E8FCCF] transition-all cursor-pointer duration-200">Welcome {username}!</h2>
                    </div>
                    ...
                    <div className="profile-data-card-xl flex justify-evenly items-center mt-16 translate-x-[-1500px] xl:translate-x-0 bg-[#96E072] hover:bg-[#3DA35D] w-1/4 py-10 shadow-2xl shadow-[#96E072] hover:shadow-[#3DA35D] rounded-2xl hover:scale-110 transition-all duration-300">
                        {publicPlaylists <= 3 ? (
                            publicPlaylistImages.map((image, index) => (
                                <a href={publicPlaylistUrls[index]} className={`w-1/${publicPlaylists+1}`}> 
